...
@Component({
  selector: 'app-preview-sport',
  templateUrl: './preview-sport.component.html',
  styleUrls: ['./preview-sport.component.scss', '../../stylesheet/preview-style.scss']
})
export class PreviewSportComponent implements OnInit {
