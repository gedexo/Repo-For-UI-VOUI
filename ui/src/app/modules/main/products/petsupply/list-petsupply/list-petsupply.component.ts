...
@Component({
  selector: 'app-list-petsupply',
  templateUrl: './list-petsupply.component.html',
  styleUrls: ['./list-petsupply.component.scss',  '../../stylesheet/list-style.scss']
})
export class ListPetsupplyComponent implements OnInit {

  totalItems :number ;
  murugan =0;
  offer_title ="Pet supply Section title";
