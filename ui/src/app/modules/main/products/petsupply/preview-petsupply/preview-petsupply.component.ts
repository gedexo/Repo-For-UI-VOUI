...
@Component({
  selector: 'app-preview-petsupply',
  templateUrl: './preview-petsupply.component.html',
  styleUrls: ['./preview-petsupply.component.scss','../../stylesheet/preview-style.scss']
})
export class PreviewPetsupplyComponent implements OnInit {
