...
@Component({
  selector: 'app-preview-fashion',
  templateUrl: './preview-fashion.component.html',
  styleUrls: ['./preview-fashion.component.scss','../../stylesheet/preview-style.scss']
})
export class PreviewFashionComponent implements OnInit {
