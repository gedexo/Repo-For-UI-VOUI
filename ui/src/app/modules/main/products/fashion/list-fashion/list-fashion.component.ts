...
@Component({
  selector: 'app-list-fashion',
  templateUrl: './list-fashion.component.html',
  styleUrls: ['./list-fashion.component.scss',  '../../stylesheet/list-style.scss']
})
export class ListFashionComponent implements OnInit {

  totalItems :number ;
  murugan =0;
  offer_title ="Fashion Section title";
