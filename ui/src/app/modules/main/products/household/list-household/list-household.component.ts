...
@Component({
  ...
  styleUrls: ['./list-household.component.scss',  '../../stylesheet/list-style.scss']
})
export class ListHouseholdComponent implements OnInit {
...
ngOnInit(): void {
  ...
  productPreview(event:any):void{
    ...
    this.router.navigateByUrl('household/preview', { state: event });
  }
}
