...
@Component({
  selector: 'app-list-beauty',
  templateUrl: './list-beauty.component.html',
  styleUrls: ['./list-beauty.component.scss',  '../../stylesheet/list-style.scss']
})
export class ListBeautyComponent implements OnInit {
  ...
  if(this.category === 'mainCategories'){
    this.listBeautyService.getDataofMainCategory(this.categoryId).subscribe(data =>{
      console.log(data);
    })
  }
  }
