...
@Component({
  selector: 'app-preview-beauty',
  templateUrl: './preview-beauty.component.html',
  styleUrls: ['./preview-beauty.component.scss','../../stylesheet/preview-style.scss']
})
export class PreviewBeautyComponent implements OnInit {
