...
@Component({
  selector: 'app-preview-automoto',
  templateUrl: './preview-automoto.component.html',
  styleUrls: ['./preview-automoto.component.scss','../../stylesheet/preview-style.scss']
})
export class PreviewAutomotoComponent implements OnInit {
